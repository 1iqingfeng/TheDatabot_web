...
import org.thedatabot.thedatabot.entity.httpinterface.VMYApiServer;
...
public class NapCatQQConfig {
    ...
    // 第二个 BASE_URL
    private static final String BASE_URL_2 = "https://api.52vmy.cn/api/wl/";
    ...
    @Bean
    public VMYApiServer imageClient(Retrofit retrofit2) {
        return retrofit2.create(VMYApiServer.class);
    }
